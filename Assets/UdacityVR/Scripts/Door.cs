...
public class Door : MonoBehaviour {
	...
	void Start () {
		...
		leftDoorStartRotation = Quaternion.Euler (-89.98f,0f,90.037f);
		leftDoorEndRotation =  Quaternion.Euler (-89.98f,-100f,90.037f);
		...
		rightDoorStartRotation = Quaternion.Euler (-90.000f,0f,-90.031f);
		rightDoorEndRotation =  Quaternion.Euler (-90.000f,100f,-90.031f);
