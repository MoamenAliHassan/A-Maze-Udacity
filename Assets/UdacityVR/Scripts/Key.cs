...
public class Key : MonoBehaviour {
	...
	void Update () {
		...
		keyvariable.transform.Rotate(0f,200f*Time.deltaTime,0f,Space.World);
	...
	public void OnKeyClicked () {
		...
		door.Unlock ();
		Object.Instantiate (keyPoofPrefab, keyvariable.transform);
		Destroy(keyvariable,0.5f);
	}
